...
public class ProjetService {
    ...
    public List<ProjetDto> findByTest(String name) {return projetMapper.toDtos((projetRepository.findByTest(name)));}

    public List<ProjetDto> findByName(String name) {return projetMapper.toDtos((projetRepository.findByName(name)));}
